...
export default function TransformValidationErrors(validationErrors: ValidationError[] = []): BadRequestException {
  return new BadRequestException(
    {
      error: 'Validation error',
      message: Object.fromEntries(validationErrors.map((e) => {
